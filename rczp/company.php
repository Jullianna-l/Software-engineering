...
<div class="top">
    <div class="wt1002">
        <div class="r">
            ...
            <div class="topsearch">
              <form action="company.php" method="get" id="spform" name="spform">
                    <input type="text" value="" class="tetPut" name="rencai"  placeholder="输入公司信息" />
    ...
    <div class="fwmain_nright r mTop10">
        <div class="label">
            ...
            <ul class="label_pad mTop10"  id="all">
                ...
                if(!empty($zpgw)){
                    $sql=$sql." and ( name like '%".$zpgw."%' or intro like '%".$zpgw."%'  or address like '%".$zpgw."%'  )  ";
                }
                ...
                while($row=mysqli_fetch_array($result)){
                    ?>
                    <li><span><?=$row['create_time']?></span><a href="company_detail.php?id=<?=$row['id']?>"><?=$row['name']?> <?=$row['address']?></a></li>
                    <?php
                    $i=$i+1;
                }
