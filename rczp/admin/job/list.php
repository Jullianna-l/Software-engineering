...
?>
<HTML ><HEAD id=Head1><TITLE>招聘信息列表</TITLE>
...
<FORM name="form" method="post" action="" >
    ...
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            $sql="select * from job where 1=1 ";//拼接留言sql语句
            ...
            $query1="select count(*) as total from job  where 1=1  ";


            if(!empty($keyword)){
                $sql=$sql." and (   title like '%".$keyword."%' or  treatment like '%".$keyword."%' or requirement like '%".$keyword."%')  ";
                $query1=$query1." and (   title like '%".$keyword."%' or  treatment like '%".$keyword."%' or requirement like '%".$keyword."%')  ";
            ...
            ?>
                    <tr>
                        <td  align="center" height="28"  ><?=$row2['name']?></td>

                        <td  align="center" height="28"  ><?=$row['title']?></td>

                        <td  align="center" height="28"  ><?=$row['salary']?></td>

                        <td  align="center" height="28"  ><?=$row['treatment']?></td>
                        ...
                        <td>
                            <div class="button-group">
                                ...
                                <a href="../../job_detail.php?id=<?=$row['id']?>" class="button border-main" >查看</a>
                            </div>
                        </td>
