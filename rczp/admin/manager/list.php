...
?>
<HTML ><HEAD id=Head1><TITLE>管理员信息列表</TITLE>
...
<FORM name="form" method="post" action="" >
    ...
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            $sql="select * from admin where 1=1 ";//拼接留言sql语句

            $keyword=$_GET["keyword"];



            $query1="select count(*) as total from admin  where 1=1  ";


            if(!empty($keyword)){
                $sql=$sql." and (   username like '%".$keyword."%' )  ";
                $query1=$query1." and (   username like '%".$keyword."%' )  ";
