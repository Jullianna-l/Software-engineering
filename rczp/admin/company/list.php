...
?>
<HTML ><HEAD id=Head1><TITLE>公司信息列表</TITLE>

    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, company-scalable=no" />
...
<FORM name="form" method="post" action="" >
    ...
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            $sql="select * from company where 1=1 ";//拼接留言sql语句

            $keyword=$_GET["keyword"];

            $query1="select count(*) as total from company  where 1=1  ";

            if(!empty($keyword)){
                $sql=$sql." and (   username like '%".$keyword."%' or  name like '%".$keyword."%' or address like '%".$keyword."%'   or intro like '%".$keyword."%')  ";
                $query1=$query1." and (   username like '%".$keyword."%' or  name like '%".$keyword."%' or address like '%".$keyword."%'   or intro like '%".$keyword."%')  ";
            ...
            ?>
                    <tr>
                        ...
                        <td  align="center" height="28"  ><?=$row['intro']?></td>
                        ...
                        <td>
                            <div class="button-group">
                                ...
                                <a href="../../company_detail.php?id=<?=$row['id']?>" class="button border-main" >查看</a>
                            </div>
                        </td>
