...
<div class="wt1002 fwmain">
    <div class="fwmain_nright r mTop10">
        <div class="label">
            ...
            <div class="label_head"><div class="label_title">最新招聘</div></div>
            <ul class="label_pad mTop10"  id="all1">
            ...
            <div class="label_head"><div class="label_title">最新人才</div></div>
            <ul class="label_pad mTop10"  id="all">
                <?php


                $sql="select * from user where status=1 order by id desc limit 0,5";

                $result=mysqli_query($con,$sql);
                $i=1;
                while($row=mysqli_fetch_array($result)){
                    ?>
                    <li><span><?=$row['create_time']?></span><a href="talent_detail.php?id=<?=$row['id']?>"><?=$row['username']?></a></li>
                    <?php
                    $i=$i+1;
                }
